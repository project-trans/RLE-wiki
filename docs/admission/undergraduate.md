...
强基计划往往针对基础学科，也就是数学，物理、化学、生物、基础医学等，此类学科往往更偏理论、有一定的就业难度，但对学科的整体发展有一定的推动作用。从就业的角度来讲，需谨慎考虑纯理论的学科。近年来强基计划也开始覆盖「热门工科与前沿交叉方向」等。

强基计划专业的内容与其名称可能不完全一致，例如名为「信息与计算科学」（如北大、南大等）「数学与应用数学（智能科学）」（如中大，该专业属于计算机学院，另有一「数学与应用数学」专业属于数学学院）的专业可能更接近计算机科学与技术专业，名为「应用物理学」（如北大）的专业可能更接近微电子科学与工程专业，部分学校「汉语言文学（古文字学方向）」专业的本科培养方案已调整为与一般的「汉语言文学」专业一致，报考前需认真阅读培养计划。
