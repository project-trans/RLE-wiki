...
两校区均靠近地铁并设有班车，班车发车频次低但是高峰期可使用公交车道。两校区间地铁通勤约 1 小时 30 分，校车约 1 小时。所有学生均同时拥有两校区的通行、消费和网络访问权限。

## 军训与体育

### 军训

19 级以后大多在校内军训，军训手册虽然要求男生不留长发，但是不会强制要求理发，可以正常通过军训。

> 学校军训要求理发，但拒绝理发仅会扣除相应考核分，学校及教官不会再次纠缠。据笔者 (Vincy SHI) 观察，大多数发型不合格的同学选择接受扣分而不理发。这会导致军训成绩降低，但一般不会因此挂科。
...
- 在入学时加入部分需要在军训期间离队工作的学生组织，可借口外出拍摄等理由离队，不会影响军训考勤。
  > 每年政策不同，近年来也有由于宣传口的收紧、减少训练拍摄活动导致无法再通过此方式逃避训练的情况。
- 在军训期间反复身体不适或体力不支，确无法胜任全部训练任务的，可申请加入病号排。病号排仍需完整参加军训，包括内务、军事理论学习等非体力训练标准不会降低。但是会减少体力训练时间和强度。病号排军训成绩给 70 分。

### 补训

补训，指因身体原因无法跟本届学生参加军训的，可以在毕业前参加学校统一组织的补训，医院证明方面同免训相同。

一般与新生军训同步展开。训练强度与补训人员相关。如 2023 年补训人数有几百人，则训练14天，全天训练。而2024年不超百人，则只训 7 天，除周末全天训练，平时在晚上训练。训练项目均为队列练习。补训对发型没有要求。补训成绩原则上最高 85 分，一般在 80 分左右。缺勤一次扣20分，缺勤两次直接不及格，仍需继续补训。担当补训任务的教官为大学生退役兵，比较好说话。训练快结束时会有领导检阅。

### 体育和体测

学校大一大二两年（四个学期）开设体育课。体测为大一大二必测，大三大四抽测 (按照专业类别整专业抽测)。自 2025 年毕业生起，体测成绩低于 50 分将影响毕业。

大一上学期统一安排学习篮球或排球课程，男女生分班上课。自大一下起，体育课项目自选，仅瑜伽、形体等少数项目仅限女生选择，其他项目班级均为男女通选，混合上课。无仅限男生选择的项目。
...
良乡校区自 2023 年新生入学起，租借隔壁北京经贸职业学院两栋宿舍楼供大一、研一新生使用，大二、研二再迁入学校本部重新分配宿舍。学校内部以“良乡校区北区”代指经贸学院宿舍区，将租借的两栋宿舍楼编为良乡校区 15、16 号宿舍。
...
| 公共洗衣 |        ✓         |            ✓             |                          ✓                           |        ✓         |
| 24h 供电 |      仅空调      |          仅空调          |                  仅空调、浴室吹风机                  |      仅空调      |
| 24h 网络 |        ✓         |            ✓             |                          ✓                           |        ✓         |

> 宿舍夜间会断电，但空调和西区宿舍的浴室吹风机插口不受影响。部分房间夜间用电可以私接接线板，白天拔除的话基本不会被发现。
...
> 对于中区部分暂未安装澡堂隔板的宿舍组团，其公共澡堂都有一个很隐蔽的位置只有一个喷头，但该位置比较抢手，独自洗浴时也无法阻止他人步入。

宿舍分配规则各学院不尽相同。一般来说，同一个班级会分在一起，不存在半个班在中区、半个班在西区的情况。但在良乡校区的各学院均有班级在西区宿舍，因此不排除可以协商调整的可能。

宿舍方面，基本的消防安全检查和门禁由学校统一管理，纪律、卫生等检查工作由学院管理。各学院检查标准有差异，但检查频率一般很低。

> 大部分学院不限制安装床帘。

在校住宿费良乡校区每年 900 ~ 1400 元不等，阜成路校区每年 500 ~ 900 元不等。
...
> **学校严格禁止因个人原因休学或延毕的学生享受公费医疗，但因病休学的学生不在此限。**
...
> 首次就诊若没有“易性症”相关证明材料，建议先以“抑郁”为由要求转往专科医院，校医院会给予支持。抑郁状态及抑郁症不属于法规要求通报的精神疾病，因此校医院不会泄露相关诊疗信息。
