...
> 宿舍夜间会断电，但空调和西区宿舍的浴室吹风机插口不受影响。夜间用电可以私接接线板，白天拔除的话基本不会被发现。
...
宿舍方面，基本的消防安全检查和门禁由学校统一管理。纪律、卫生等检查工作由宿管每周进宿舍进行检查并给分，主要检查违规使用电器和卫生情况，分数会在综合测评中出现。学院因为协调的原因很少进宿舍检查，商学院去年一年就组织了一次。
