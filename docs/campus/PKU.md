...
与隔壁不同，校园卡（学生卡）上不印性别标记，在校园卡中心支付20元制卡费可以替换自己喜欢的证件照：用手机把照片传给工作人员印到卡上，提要求说想换照片，工作人员有边界感不会盘问。[注：校园卡系统后台仍然存储了证件信息和性别标记，且不会自动从全校信息系统中同步，虽然不知道这些信息最终有什么作用，因为并不影响卡片的使用。但如有意愿，可在变更身份信息后在校园卡中心手动修改。]
