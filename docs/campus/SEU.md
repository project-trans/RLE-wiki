...
此外还有丁家桥校区（医学院，公共卫生学院，中大医院）和无锡校区（目前已知的是集成电路学院大三前往）。
...
>根据笔者个人经历，如果直接在不提供其他信息的情况下向辅导员要求开具介绍信可能会引起不必要的怀疑（辅导员似乎有一定了解，笔者在并未提供具体医院名称的情况下直接被点出，可能是因为精神科开具用于休学的诊断证明也需要介绍信），建议使用在读证明替代。
>
...
>湖区的校园活动观察下来主要以学校举行的各类讲座为主，学生社团活跃度差异较大，课余生活的时间需要自己填充（当然也有可能在比较忙的时候没有课余时间）。根据零星的线索，笔者确信在桃园宿某舍应当有 MtF ，但由于缺乏校内交流渠道故真实性无法得知。
...
>关于计算机类专业，目前分为四个专业两个学院，即计算机科学与工程学院、软件学院、人工智能学院，下有计算机科学与工程专业，软件工程专业，人工智能专业，以及网络空间安全学院，下有网络空间安全专业。这四个专业目前是在一起大类招生，大一下会进行分流。（计软智学院下还有一个独立的拔尖班。）如果入学时托管在计软智学院下而分流后进入了网安，会面临换辅导员以及有概率需要换宿舍的情况（计算机类23级政策是需要一个宿舍至少有两个同学院的学生），反之亦然。换宿舍需要自己和换入宿舍协调。似乎其它学院并没有这一要求。
>
...
>
>计软智的三个专业毕业都要求实习，其中软工需要在大四连续实习满 9（还是多少）个月，另外两个专业一般在大三升大四的暑假实习，网安不详。实习似乎是不用住宿舍甚至回学校的。
