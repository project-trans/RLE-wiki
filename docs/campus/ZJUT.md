...
|        项目        |  情况  |                 备注                 |
| :----------------: | :----: | :----------------------------------: |
|      宿舍独卫      |  many  |        朝晖尚德园没独卫，梦溪村有        |
|      宿舍独浴      |  many  |        朝晖尚德园没独浴 ，梦溪村有       |
...
### 体育与军训
体育方面，23年？以来把体侧（长短跑，引体/仰卧，立定跳）的占比调高到40%，并且大一大二+大三上5个学期均有体侧项目。若折算出来的成绩不及格下学期会强制报体能班（能否因性别改标准待确认）。

体育课有分3类：男、女、混，选课时只会出现对应性别+混的选项，还算友好。我上的是混排，有按性别进行搭档分组的，别的课有没有尚不清楚。

军训方面，25年开始应该是在大一9月份开始军训2周（以前是大二暑假）。开始前有号称注意仪容仪表，但也就是口头说说，我的头发不算很长，塞到帽子里就O了。一般的要求就是不烫不染（不太过分就行），但我遇到的教官和导员都没有强制要求，别的不清楚
