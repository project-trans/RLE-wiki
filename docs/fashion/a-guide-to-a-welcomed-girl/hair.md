...
找到一个技术过关的Tony并不是一个十分困难的问题。如果你有一个关系比较好的女性朋友，那么她大概率会知道哪位Tony的技术比较好。（其实就是她试过许多店后最后决定常去的那位）

但如果你和我最初的情况一样自闭，那么打开你的手机，下载一个美团，让市场的力量帮助你解决问题！
